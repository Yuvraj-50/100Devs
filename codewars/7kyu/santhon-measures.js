// question url : https://www.codewars.com/kata/59a1cdde9f922b83ee00003b/solutions/javascript
...
function stantonMeasure(arr) {
  const numberOfOnes = arr.filter((num) => num == 1).length;
  return arr.filter((num) => num == numberOfOnes).length;
}
